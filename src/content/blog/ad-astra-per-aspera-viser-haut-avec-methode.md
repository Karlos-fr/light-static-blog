...
> Une bonne page ne cherche pas à tout montrer. Elle montre juste assez pour donner confiance.
...
```json
{
  ...
  "status": "demo",
  "sections": ["image", "liste", "tableau", "code"]
}
```
...
La locution donne une direction ; la structure Markdown donne le chemin.
