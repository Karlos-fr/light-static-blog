...
Le contenu peut être structuré avec des paragraphes courts, des intertitres lisibles et quelques éléments de mise en valeur.
...
| Élément | Rôle |
| --- | --- |
| Titre | Donner le sujet |
| Liste | Scander les idées |
| Code | Montrer un exemple précis |
